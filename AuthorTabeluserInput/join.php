...
<?php
	...
	$results = mysqli_query( $connect, "SELECT c.Book_Title,a.Author_Name FROM author AS a INNER JOIN category AS c ON a.ISBN = c.ISBN" )

		or die("Can not execute query");

    
	echo "<table class='ui celled table'style='max-width: 500px; margin :0 auto;'> \n";
	echo "<tr><thead><th>Book_Title</th> <th>Author_Name</th> </tr>\n";
